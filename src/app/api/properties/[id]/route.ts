...
export async function PATCH(req: NextRequest, context: RouteContext) {
  try {
    ...
    if (body.propertyType !== undefined) updates.propertyType = (body.propertyType as string)?.trim() || null;
    if (body.bedrooms !== undefined) updates.bedrooms = body.bedrooms ? parseInt(body.bedrooms as string, 10) : null;
